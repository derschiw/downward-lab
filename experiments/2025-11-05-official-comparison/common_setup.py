...
class IssueExperiment(FastDownwardExperiment):
    ...
    def add_scatter_plot_step(self, relative=False, attributes=None, additional=[]):
        ...
        def make_scatter_plot():
            algo1 = "main-with-pcfstrategy-keyword"
            algo2 = "OFFICIAL-without-pcfstrategy-keyword"
            for attribute in attributes:
                ...
                report(
                    self.eval_dir,
                    os.path.join(scatter_dir, "main-vs-OFFICIAL-" + attribute))

        self.add_step(step_name, make_scatter_plot)
